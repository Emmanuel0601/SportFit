...
<main>
  <section id="product">
    <?php
      ...
      // Consulta para obtener los productos de hombre
      $sql = "SELECT * FROM productos WHERE tipoProducto = 'Hombre' ORDER BY id DESC";
      ...
      if ($result->num_rows > 0) {
        ...
        echo "No hay productos de hombre disponibles.";
      }
