...
<main>
  <section id="product">
    <?php
      ...
      // Consulta para obtener los productos de mujer
      $sql = "SELECT * FROM productos WHERE tipoProducto = 'Mujer' ORDER BY id DESC";
      ...
      if ($result->num_rows > 0) {
        ...
        echo "No hay productos de mujer disponibles.";
      }
