...
<header>
    ...
    <main>
        <section id="product">
            ...
            // Consulta para obtener los últimos 20 productos
        ...
        <div class="contenedor-footer">
            <div class="box">
                ...
                <div class="footer-texto">
                    ...
                    <p>Correo Electrónico: <span><a href="info@tiendasportfit.com">info@tiendasportfit.com</a></span></p>
                </div>
            </div>
            <div class="box">
                <!--Menu footer-->
                ...
                <a href="ProductosMujer.php">Mujer</a>
                <a href="ProductosHombre.php">Hombre</a>
                <a href="../HTML/quienes_somos.html">Nosotros</a>
                <a href="ProductosArticulos.php">Artículos</a>
